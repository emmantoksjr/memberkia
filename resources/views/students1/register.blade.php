                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post">
                            ...
                            @endif
                            <div class="mdl-textfield  mdl-textfield--full-width mdl-js-textfield mdl-textfield--floating-label">
                                <input class="mdl-textfield__input" name="middlename" value="{{ old('middlename') }}" type="text" id="name">
                                <label class="mdl-textfield__label" for="name">Middle Name <span class="required">*</span></label>
                            </div>
                            ...
                            @endif
                            <p class="alert alert-warning" style="display: none" id="nshow">Admission year cannot be greater than expected Date of birth</p>
                            ...
                            <div class="mdl-textfield  mdl-textfield--full-width mdl-js-textfield mdl-textfield--floating-label">
                                ...
                                <label class="mdl-textfield__label" for="phone">Next of kin address<span class="required">*</span></label>
                            </div>
                            ...
                            <div class="mdl-textfield  mdl-textfield--full-width mdl-js-textfield mdl-textfield--floating-label">
                                ...
                                <label class="mdl-textfield__label" for="phone">Sponsor Name<span class="required">*</span></label>
                            </div>
                            ...
                            <div class="mdl-textfield  mdl-textfield--full-width mdl-js-textfield mdl-textfield--floating-label">
                                ...
                                <label class="mdl-textfield__label" for="phone">Sponsor Address<span class="required">*</span></label>
                            </div>
                            ...
                            <div class="mdl-textfield  mdl-textfield--full-width mdl-js-textfield mdl-textfield--floating-label">
                                ...
                                <label class="mdl-textfield__label" for="phone">Sponsor Phone<span class="required">*</span></label>
                            </div>
