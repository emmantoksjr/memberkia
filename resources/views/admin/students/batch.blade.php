        ...
        <div class="page-content pt-3">
            <div class="container" style="max-width: 600px;">
                <p style="margin-left: 20px;">
                    Follow the below  CSV structure to create your upload format.
                    <br/>
                    NAMES,MATRIC,LEVEL<br/>
                    Adams James B,1001000,100<br />
                ...
                <div class="outer-body text-center">
                    <h3>Select file</h3>
                    <p>file should be <b>COMMA DELIMITED</b> and saved as <b>.csv</b></p>
