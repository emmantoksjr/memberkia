                ...
                <form method="POST">
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ $due->name }}" placeholder="" class="form-control">
                        </div>
                        @if ($errors->has('name'))
                ...
                @endif
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <input type="number" name="amount" value="{{ $due->amount }}"  placeholder="" class="form-control">
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group no-margin">
                                ...
                                <div class="radio radio-info form-check-inline">
                                    <input type="radio" id="inlineRadio2" name="options" value="1"  {{ $due->viewers == 1 ? 'checked' : 'notchecked' }}>
                                    <label for="inlineRadio2"> Student </label>
                                </div>
                                <div class="radio radio-info form-check-inline">
                                    <input type="radio" id="inlineRadio1" value="2" name="options" {{ $due->viewers == 2 ? 'checked' : 'notchecked' }}>
                                    <label for="inlineRadio1"> Alumni</label>
                                </div>
                                <div class="radio radio-info form-check-inline">
                                    <input type="radio" id="inlineRadio3" value="3" name="options" {{ $due->viewers == 3 ? 'checked' : 'notchecked' }}>
        ...
        <form class="p-4" method="post">
            ...
            <div class="form-group">
                <div class="mdl-textfield  mdl-textfield--full-width mdl-js-textfield mdl-textfield--floating-label">
                    <input class="mdl-textfield__input" name="name" value="{{ $due->name }}" type="text" id="name">
                    <label class="mdl-textfield__label" for="name">Name <small>(required)</small></label>
                </div>
                @if ($errors->has('name'))
            ...
            <div class="form-group">
                <div class="mdl-textfield  mdl-textfield--full-width mdl-js-textfield mdl-textfield--floating-label">
                    <input class="mdl-textfield__input" name="amount" value="{{ $due->amount }}" type="text" id="amount">
            ...
            <div class="form-group">
                ...
                <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-1">
                    <input type="radio" id="option-1" class="mdl-radio__button" name="options" value="1" {{ $due->viewers == 1 ? 'checked' : 'notchecked' }}>
                    <span class="mdl-radio__label">Student</span>
                </label>
                <label class="mdl-radio mdl-js-radio ml-4 mdl-js-ripple-effect" for="option-2">
                    <input type="radio" id="option-2" class="mdl-radio__button" name="options" value="2" {{ $due->viewers == 2 ? 'checked' : 'notchecked' }}>
                    <span class="mdl-radio__label">Alumni</span>
                </label>
                <label class="mdl-radio mdl-js-radio ml-4 mdl-js-ripple-effect" for="option-3">
                    <input type="radio" id="option-3" class="mdl-radio__button" name="options" value="3" {{ $due->viewers == 3 ? 'checked' : 'notchecked' }}>
                    <span class="mdl-radio__label">Both</span>
                </label>
            </div>

            <div class="form-group">
                <button type="submit" class="mdl-button mdl-js-button text-center mdl-button--raised mdl-button mdl-button--colored">Save Due</button>
