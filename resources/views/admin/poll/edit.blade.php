...
<div class="container">
    ...
    <input type="text" required name="title" value="{{ $polls->title}}" id="title" class="form-control">
        @if ($errors->has('title'))
      ...
      <div class="div-group">
        ...
        <textarea name="description" required id="description" class="form-control" cols="10" rows="5">{{ $polls->description}}</textarea>
      ...
      {{-- <div class="div-group">
        ...
        <input type="datetime-local" required name="tostart" id="deadline" class="form-control">
      ...
      <div class="div-group">
        ...
        <input type="datetime-local" required name="deadline" value="{{ $polls->deadline}}" id="deadline" class="form-control">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" id="candidate1" value="{{ $polls->cand1}}" required name="cand1" class="form-control">
          </div>
          @if ($errors->has('cand1'))
          <p class="alert alert-danger">
      ...
      @endif
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" id="candidate2" value="{{ $polls->cand2}}" required name="cand2" class="form-control">
          </div>
          @if ($errors->has('cand2'))
          <p class="alert alert-danger">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" id="candidate3" value="{{ $polls->cand3}}" required name="cand3" class="form-control">
          </div>
          @if ($errors->has('cand3'))
          <p class="alert alert-danger">
      ...
      @endif
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" id="candidate4"required value="{{ $polls->cand4}}" name="cand4" class="form-control">
          </div>
          @if ($errors->has('cand4'))
          <p class="alert alert-danger">
      ...
      <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" id="candidate3"required value="{{ $polls->cand5}}" name="cand5" class="form-control">
              </div>
              @if ($errors->has('cand5'))
              <p class="alert alert-danger">
          ...
          @endif
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" id="candidate4" value="{{ $polls->cand6}}" name="cand6" class="form-control">
              </div>
              @if ($errors->has('cand6'))
              <p class="alert alert-danger">
          ...
          <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" id="candidate3" value="{{ $polls->cand7}}" name="cand7" class="form-control">
                  </div>
                  @if ($errors->has('cand7'))
                  <p class="alert alert-danger">
              ...
              @endif
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" id="candidate4" value="{{ $polls->cand4}}" name="cand4" class="form-control">
                  </div>
                  @if ($errors->has('cand4'))
                  <p class="alert alert-danger">
                      <span>{{ $errors->first('cand4') }}</span>
